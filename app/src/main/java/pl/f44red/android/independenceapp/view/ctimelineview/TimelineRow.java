package pl.f44red.android.independenceapp.view.ctimelineview;
...
public class TimelineRow {
    ...
    private int bellowLineColor = Color.argb(255, 0, 0, 0);
    private int bellowLineSize = 0;
    private int imageSize = 60;
    private int backgroundColor = Color.argb(255, 0, 0, 0);
    private int backgroundSize = 50;
    private int dateColor = Color.argb(255, 0, 0, 0);
    private int titleColor = Color.argb(255, 0, 0, 0);
    private int descriptionColor = Color.argb(255, 0, 0, 0);
